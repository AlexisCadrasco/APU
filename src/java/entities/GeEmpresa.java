...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "GeEmpresa.findAll", query = "SELECT g FROM GeEmpresa g")})
public class GeEmpresa implements Serializable {
    ...
    public GeEmpresa(Long id) {
        this.id = id;
    }

    public GeEmpresa(Long id, short estadoregistro, String usuariocreacion, Date fechacreacion) {
        this.id = id;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GeEmpresa)) {
            return false;
        }
        GeEmpresa other = (GeEmpresa) object;
    ...
    public String toString() {
        return "entities.GeEmpresa[ id=" + id + " ]";
    }
