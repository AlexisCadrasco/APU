 ...
 */
@Entity
@Table(name = "IF_APU_MANO_OBRA")
@XmlRootElement
public class IfApuManoObra implements Serializable {
    ...
    private BigInteger rendimiento;
    @Column(name = "JORNAL")
    private double jornal;
    @Column(name = "PRESTACIONES")
    private BigInteger prestaciones;
    ...
    public IfApuManoObra() {
    }

    public IfApuManoObra(BigDecimal id) {
        this.id = id;
    }
    ...
    public BigInteger getRendimiento() {
        return rendimiento;
    }

    public void setRendimiento(BigInteger rendimiento) {
    ...
    public BigInteger getPrestaciones() {
        return prestaciones;
    }

    public void setPrestaciones(BigInteger prestaciones) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof IfApuManoObra)) {
            return false;
        }
        IfApuManoObra other = (IfApuManoObra) object;
    ...
    public String toString() {
        return "entities.IfApuManoObra[ id=" + id + " ]";
    }
