 ...
 */
@Entity
@Table(name = "GE_SUB_GRUPO")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "GeSubGrupo.findAll", query = "SELECT g FROM GeSubGrupo g")})
public class GeSubGrupo implements Serializable {
    ...
    public GeSubGrupo(BigDecimal id) {
        this.id = id;
    }

    public GeSubGrupo(BigDecimal id, String nombre, BigInteger empresa, short estadoregistro, String usuariocreacion, Date fechacreacion) {
        this.id = id;
        this.nombre = nombre;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GeSubGrupo)) {
            return false;
        }
        GeSubGrupo other = (GeSubGrupo) object;
    ...
    public String toString() {
        return "entities.GeSubGrupo[ id=" + id + " ]";
    }
