 ...
 */
@Entity
@Table(name = "GE_PRODUCTO")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "GeProducto.findAll", query = "SELECT g FROM GeProducto g")})
public class GeProducto implements Serializable {
    ...
    public GeProducto(BigDecimal id) {
        this.id = id;
    }

    public GeProducto(BigDecimal id, String nombre, BigInteger empresa, short estadoregistro, String usuariocreacion, Date fechacreacion) {
        this.id = id;
        this.nombre = nombre;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GeProducto)) {
            return false;
        }
        GeProducto other = (GeProducto) object;
    ...
    public String toString() {
        return "entities.GeProducto[ id=" + id + " ]";
    }
