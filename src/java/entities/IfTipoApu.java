 ...
 */
@Entity
@Table(name = "IF_TIPO_APU")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "IfTipoApu.findAll", query = "SELECT i FROM IfTipoApu i")})
public class IfTipoApu implements Serializable {
    ...
    public IfTipoApu(Long id) {
        this.id = id;
    }

    public IfTipoApu(Long id, String nombre, BigInteger empresa, short estadoregistro, String usuariocreacion, Date fechacreacion) {
        this.id = id;
        this.nombre = nombre;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof IfTipoApu)) {
            return false;
        }
        IfTipoApu other = (IfTipoApu) object;
    ...
    public String toString() {
        return "entities.IfTipoApu[ id=" + id + " ]";
    }
