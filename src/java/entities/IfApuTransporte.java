 ...
 */
@Entity
@Table(name = "IF_APU_TRANSPORTE")
@XmlRootElement
public class IfApuTransporte implements Serializable {
    ...
    public IfApuTransporte() {
    }

    public IfApuTransporte(BigDecimal id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof IfApuTransporte)) {
            return false;
        }
        IfApuTransporte other = (IfApuTransporte) object;
    ...
    public String toString() {
        return "entities.IfApuTransporte[ id=" + id + " ]";
    }
